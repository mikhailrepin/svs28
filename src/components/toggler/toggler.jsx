      ...
      <div css={css`${wrapper}`}>
        ...
        <div css={css`${iconWrapper}; ${sun}`}>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
            <path fill-rule="evenodd" d="M8 1a.66.66 0 0 1 .66.66v.438a.66.66 0 1 1-1.32 0V1.66A.66.66 0 0 1 8 1ZM3.05 3.05a.66.66 0 0 1 .934 0l.309.31a.66.66 0 0 1-.934.933l-.31-.309a.66.66 0 0 1 0-.934Zm9.9 0a.66.66 0 0 1 0 .934l-.309.31a.66.66 0 0 1-.934-.935l.31-.309a.66.66 0 0 1 .933 0ZM3.833 7.976a4.158 4.158 0 1 1 8.317 0 4.158 4.158 0 0 1-8.317 0ZM1 8a.66.66 0 0 1 .66-.66h.438a.66.66 0 1 1 0 1.32H1.66A.66.66 0 0 1 1 8Zm12.242 0a.66.66 0 0 1 .66-.66h.438a.66.66 0 0 1 0 1.32h-.438a.66.66 0 0 1-.66-.66Zm-1.535 3.707a.66.66 0 0 1 .934 0l.31.309a.66.66 0 1 1-.935.934l-.309-.31a.66.66 0 0 1 0-.933Zm-7.414 0a.66.66 0 0 1 0 .934l-.31.309a.66.66 0 1 1-.933-.934l.309-.31a.66.66 0 0 1 .934 0ZM8 13.242a.66.66 0 0 1 .66.66v.438a.66.66 0 0 1-1.32 0v-.438a.66.66 0 0 1 .66-.66Z" clip-rule="evenodd"/>
          </svg>
        </div>
        <div css={css`${iconWrapper}; ${moon}`}>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
            <path fill-rule="evenodd" d="M6.905 2.166a.566.566 0 0 1 .142.564 4.987 4.987 0 0 0 6.223 6.222.566.566 0 0 1 .706.706A6.119 6.119 0 1 1 6.34 2.024c.2-.06.417-.006.564.142Z" clip-rule="evenodd"/>
          </svg>
        </div>
